...
CREATE TABLE "Category" (
    ...
    "type" TEXT NOT NULL DEFAULT 'VITRINA',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "EmployeeSchedule" (
    ...
    "updatedAt" DATETIME NOT NULL,
    "updatedBy" TEXT,
    CONSTRAINT "EmployeeSchedule_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "EmployeeSchedule_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
